...
<html lang="sk">
    ...
    <body>
        <header>
            ...
            <nav class="navbar navbar-expand-lg justify-content-center">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active nav-item"><a href="memorials.php" class="nav-link">PAMÄTNÉ DNI</a></li>
        ...
        <div class="output container-fluid my-5">
            <h2>PAMÄTNÉ DNI</h2>
            <div id="memorials-output">
                <script>getOther("memorialsInput=TRUE","SKdni","memorials-output");</script>
            </div>
        </div>
