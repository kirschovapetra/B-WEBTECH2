    ...
    <header>
        ...
        <nav class="navbar navbar-expand-lg justify-content-center">
            <ul class="nav navbar-nav">
                ...
                <li class="active nav-item"><a href="SKHolidays.php" class="nav-link">SLOVENSKÉ SVIATKY</a></li>
...
<div class="output container-fluid my-5">
    <h2>SLOVENSKÉ SVIATKY</h2>
    <div id="sk-output">
        <script>getOther("SKHolidaysInput=TRUE","SKsviatky","sk-output");</script>
    </div>
</div>
